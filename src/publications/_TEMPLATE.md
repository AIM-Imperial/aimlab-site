...
#   2. Rename it like  2026-01-short-title-slug.md
#      (the filename is just for you — sorting uses the "year" and "order" below)
...
# order   (number)  — position WITHIN the year; lower = higher up. Required.
