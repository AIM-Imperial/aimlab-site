...
<figure class="project-figure" style="width: 67%">
  <img src="/assets/img/projects/reprogrammable-metamaterial/unit-cell-tessellation-design.jpg" alt="The m-bit unit cell in its ON and OFF states, its force-displacement response, and a tessellated array under mechanical loading">
...
<figure class="project-figure" style="width: 67%">
  <img src="/assets/img/projects/reprogrammable-metamaterial/magnetic-programming.jpg" alt="The bistable shell's force-displacement curve, the electromagnetic coil arrangement and magnetic field, the snapping sequence in five states, and write traces over a thousand cycles">
...
<figure class="project-figure" style="width: 67%">
  <img src="/assets/img/projects/reprogrammable-metamaterial/loading-two-states.jpg" alt="An array loaded in its all-ON and all-OFF configurations, with bar charts of stiffness, strength, and dissipated energy and the measured strain fields">
...
<figure class="project-figure" style="width: 50%">
  <img src="/assets/img/projects/reprogrammable-metamaterial/tunable-mechanical-response.jpg" alt="Force-area curves for programming ratios from zero to one, and a plot of stiffness and 2% strength rising with the programming ratio">
